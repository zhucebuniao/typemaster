  ...
  return (
    <div className="flex flex-col h-screen justify-between bg-white dark:bg-gray-900">
      ...
      <header className="flex items-center justify-between p-4">
        ...
        <h1 className="text-xl font-bold text-slate-900 dark:text-white">High Scores</h1>
      ...
      <main className="flex-grow flex flex-col items-center justify-center px-6 text-center">
        ...
        <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">High Scores</h2>
