...
const TypingGame: React.FC<TypingGameProps> = ({ 
  ...
  return (
    <div className="relative flex h-auto min-h-screen w-full flex-col justify-between overflow-x-hidden bg-white dark:bg-gray-900">
      ...
      {/* Bottom Navigation */}
      <footer className="sticky bottom-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-t border-gray-200 dark:border-gray-700">
        <nav className="flex justify-around items-center p-2">
          <button className="flex flex-col items-center gap-1 text-gray-500 dark:text-gray-400" onClick={handleBackToMenu}>
